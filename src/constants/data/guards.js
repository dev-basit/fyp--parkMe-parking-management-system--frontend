import {
  ...
  SearchGuard,
} from "../../Screens/company/GuardScreen.js";
import { AssignParkingAreaToGuardCompanyOwner } from "../../Screens/vehicle/ParkingsScreen.js";
...
export const guardScreenTabsForCompanyOwner = [
  ...
  {
    key: "3",
    label: <h4>Assign Parking Area</h4>,
    children: <AssignParkingAreaToGuardCompanyOwner />,
  },
];
